...
//go:generate xb cat -o licenses.go xzLicense:github.com/luischavez/xz/LICENSE goLicense:~/go/LICENSE
...
import (
	...
	"github.com/luischavez/xz/internal/gflag"
	"github.com/luischavez/xz/internal/term"
	"github.com/luischavez/xz/internal/xlog"
)
...
Report bugs using <https://github.com/luischavez/xz/issues>.
`
)
...
func licenses(w io.Writer) {
	out := `
github.com/luischavez/xz -- xz for Go
====================================
